...
Task-named commands and modern `--long-option` flags are shown below.
...
- Use `--minimal` to avoid broad search analysis, name resolution, and extra Kerberos command output.
